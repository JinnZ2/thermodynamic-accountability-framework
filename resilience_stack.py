...
class RegulatoryScopeAudit:
    ...
    def audit(self, reg: Regulation) -> RegulationAudit:
        ...
        if weaponization_risk >= 4:
            ...
            recommendation = (
                "MODERATE RISK: selective enforcement possible. "
                "Tighten scope and add outcome metric."
            )
        else:
...
class ResilienceStack:
    ...
    def assess(
        ...
        if unaccounted and high_risk:
            notes.append(
                "System blind to critical layers AND institutionally gatekeeping the people who could fill them. "
                "Expect accelerated failure under stress."
            )
