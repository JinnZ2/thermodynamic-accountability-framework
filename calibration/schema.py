...
1. `failing_dimensions` lists what specifically is broken.
1. `falsifiable_claims` tells you what observations would change the verdict —
   these are NOT predictions; they are the conditions under which this audit
   would be wrong.
1. Do NOT treat this report as a judgment of people. It measures ENVIRONMENTS
   that reward fragility vs. those that preserve calibration.
1. If you want to run this audit yourself, the source is CC0 at:
