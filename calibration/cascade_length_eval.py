...
THRESHOLDS = {
    ...
    "reversal_awareness":    {"green": 1,  "yellow": 0},
...
1. chain_length          causal connector count
                         (green >= 5, yellow >= 3)
2. substrate_transitions number of distinct substrate categories
                         touched (bio / hydro / geo / chem /
                         econ / social / political / etc)
                         (green >= 4, yellow >= 2)
3. reversal_awareness    feedback / buffer / counteraction markers
                         (green >= 1, yellow >= 0)
4. time_projection       distinct time horizons referenced
                         (green >= 3, yellow >= 1)
5. feedback_loops        explicit feedback references
                         (green >= 1, yellow >= 0)
