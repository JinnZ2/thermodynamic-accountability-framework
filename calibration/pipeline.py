...
Input may contain any combination of:
    - feedback_events, decisions, skills_observed,
      memorialized_skills, friction_events   (for calibration_audit)
    - skill_log                              (for observation_dependence)
    - friction_events                        (for adaptation_debt)
"""
reports = {}
...
if "friction_events" in system_desc:
    # Upgrade friction_events to adaptation_debt schema if needed
    debt_events = []
...
if **name** == “**main**”:
# Composite test — an organization with both structural and practice data
test_system = {
“system_id”: “composite_test_org”,
“cliff_threshold”: 10.0,
# For calibration_audit
“feedback_events”: [
