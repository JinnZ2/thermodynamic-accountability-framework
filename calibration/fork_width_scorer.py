...
class ForkWidthScorer:
    ...
    def score(self, answers: dict[str, str]) -> ForkReport:
        ...
        # Vocabulary overlap: shared-by-all tokens / mean frame vocab size
...
2. action_divergence   fraction of frames proposing different
                       primary actions
                       (green >= 0.60, yellow >= 0.35)
3. substrate_spread    entropy across substrate categories
                       (green >= 0.60, yellow >= 0.35)
4. min_pairwise        smallest pairwise distance
                       (green >= 0.35, yellow >= 0.15)
5. vocabulary_overlap  tokens shared across ALL frames,
