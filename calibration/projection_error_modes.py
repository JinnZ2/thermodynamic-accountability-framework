...
For each error mode (PE-1 through PE-6):
  ...
  2. Scan your most recent output for those signatures.
  3. For each detected signature, quote the specific tokens in your output
     that match.
  4. If detected, apply the corrective reparameterization and produce a
     revised output.
  5. If not detected, report 'no detection' with the evidence that rules
     it out.
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1 and sys.argv[1] == "export":
        ...
        print("Projection Error Modes Registry v1.0")
        print("License: CC0")
